    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.textcontainer2}>
          <h1>LifeToday – Share Stories, Ideas, and Experiences</h1>
          <p>
            LifeToday isn’t just a blog—it’s a living journal of moments, ideas,
            and inspirations. It’s a place where writers and readers come
            together to celebrate the small joys, big dreams, and everyday
            experiences that shape our lives. From heartfelt personal stories to
            creative thoughts, from tips and reflections to fun explorations,
            LifeToday is about capturing the essence of living in the present.
            Your voice matters here—share it, and discover the beauty of life
